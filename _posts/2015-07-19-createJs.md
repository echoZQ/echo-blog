...
示例1-扩展现有对象定义新的视觉类:[示例1](http://share.local:8002/html/easel/button.html)
...
#### 关于extend
[示例](http://share.local:8002/html/extend.html)  
...
示例2-简单的动画和时间类  [ticker1](http://share.local:8002/html/easel/timer.html)
...
Timer可以使我们很方便动态的调整不同动画的帧率 [ticker2](http://share.local:8002/html/easel/timer2.html)
...
[实例4](http://share.local:8002/html/easel/stage.html)
...
pressmove: [示例5](http://share.local:8002/html/easel/drag.html)
...
[示例](http://share.local:8002/html/sound/sound.html)
